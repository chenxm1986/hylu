...
int main(int argc, const char *argv[])
{
    if (argc < 3)
    {
        printf("Usage: ./unsym_c <mtx file> <# of threads>\n");
        printf("Example: ./unsym_c Chevron1.mtx 4\n");
    ...
    ret = HYLU_C_Analyze(instance, false, n, ap, ai, ax, 0);
    if (ret < 0)
    {
    ...
    res = L1NormOfResidual(n, ap, ai, ax, x, b, 0);
