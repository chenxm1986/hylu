...
static double L1NormOfResidual(const int n, const int ap[], const int ai[], const double ax[], const double x[], const double b[])
{
...
int main(int argc, const char *argv[])
{
    if (argc < 3)
    {
        printf("Usage: ./spd_r <mtx file> <# of threads>\n");
        printf("Example: ./spd_r shallow_water1.mtx 4\n");
    ...
    ret = HYLU_Analyze(instance, false, n, ap, ai, ax, 1);
    if (ret < 0)
    {
